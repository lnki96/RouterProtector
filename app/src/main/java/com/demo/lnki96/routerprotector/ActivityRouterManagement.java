    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(final Message msg) {
            ...
            if(!msg.getData().getBoolean("isFound")){
                tv.setText(msg.getData().getString("checking"));
                tv2.setText(msg.getData().getString("state")+"\n"+msg.getData().getString("newMac"));
            }else{
                //发现新的Mac连入,这里应该谈个对话框,提示有新的MAC地址连入了
                View layout = LayoutInflater.from(ActivityRouterManagement.this).inflate(
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ActivityRouterManagement.this);
                ...
                builder.setPositiveButton("允许接入", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        readNet("http://192.168.1.1/userRpm/WlanMacFilterRpm.htm?Mac="+newMac+"&Desc=&entryEnabled=1&Changed=0&SelIndex=0&Page=1&Save=%B1%A3+%B4%E6","3");
